...
<html lang="en">
<head>
    <title>Code coverage report for components/form/common</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> components/form/common
    </h1>
    <div class='clearfix'>
...
<tbody><tr>
	<td class="file medium" data-value="login-form.jsx"><a href="login-form.jsx.html">login-form.jsx</a></td>
	<td data-value="71.88" class="pic medium"><div class="chart"><div class="cover-fill" style="width: 71%;"></div><div class="cover-empty" style="width:29%;"></div></div></td>
