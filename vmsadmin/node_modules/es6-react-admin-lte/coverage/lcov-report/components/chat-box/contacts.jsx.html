...
<html lang="en">
<head>
    <title>Code coverage report for components/chat-box/contacts.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/chat-box</a> contacts.jsx
    </h1>
    <div class='clearfix'>
      ...
      return (
        &lt;li key={`contact${i}`}&gt;
          &lt;a
            ...
            onClick={contactDetails.onClick ? <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >e </span>=&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >              contactDetails.onClick();</span>
