...
<html lang="en">
<head>
    <title>Code coverage report for components/header-bar/header-tasks</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> components/header-bar/header-tasks
    </h1>
    <div class='clearfix'>
...
<tbody><tr>
	<td class="file medium" data-value="header-tasks.jsx"><a href="header-tasks.jsx.html">header-tasks.jsx</a></td>
...
<tr>
	<td class="file high" data-value="task-item.jsx"><a href="task-item.jsx.html">task-item.jsx</a></td>
