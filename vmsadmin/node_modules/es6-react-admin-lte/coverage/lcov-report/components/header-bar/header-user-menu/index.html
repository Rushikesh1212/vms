...
<html lang="en">
<head>
    <title>Code coverage report for components/header-bar/header-user-menu</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> components/header-bar/header-user-menu
    </h1>
    <div class='clearfix'>
...
<tbody><tr>
	<td class="file low" data-value="header-user-menu.jsx"><a href="header-user-menu.jsx.html">header-user-menu.jsx</a></td>
	<td data-value="28" class="pic low"><div class="chart"><div class="cover-fill" style="width: 28%;"></div><div class="cover-empty" style="width:72%;"></div></div></td>
