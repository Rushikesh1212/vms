...
<html lang="en">
<head>
    <title>Code coverage report for components/header-bar/header-notifications/header-notifications.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">components/header-bar/header-notifications</a> header-notifications.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  render() {
    ...
    return (
      &lt;li className={`dropdown notifications-menu${this.state.open ? <span class="branch-0 cbranch-no" title="branch not covered" >' open' </span>: ''}`} tabIndex="0" onBlur={this.toggleDropdown}&gt;
