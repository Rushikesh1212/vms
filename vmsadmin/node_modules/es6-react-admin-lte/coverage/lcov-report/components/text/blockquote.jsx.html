...
<html lang="en">
<head>
    <title>Code coverage report for components/text/blockquote.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/text</a> blockquote.jsx
    </h1>
    <div class='clearfix'>
...
class Blockquote extends React.Component {
  render() {
    return (
      &lt;blockquote className={this.props.pullRight ? 'pull-right' : <span class="branch-1 cbranch-no" title="branch not covered" >''}</span>&gt;
