...
<html lang="en">
<head>
    <title>Code coverage report for components/post/social-button.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/post</a> social-button.jsx
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        position = '';</span>
    ...
    if (this.props.type === 'like') {
      ...
      buttonName = "Like";
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if(this.props.type === 'share') {
