...
var StatTile = function (_React$Component) {
  _inherits(StatTile, _React$Component);

  function StatTile() {
    _classCallCheck(this, StatTile);

    return _possibleConstructorReturn(this, (StatTile.__proto__ || Object.getPrototypeOf(StatTile)).apply(this, arguments));
  }

  _createClass(StatTile, [{
    key: 'render',
    value: function render() {
      var _this2 = this;

      var link = '';
      var stats = _react2.default.createElement(
        'h3',
        null,
        this.props.stats
      );
      ...
      if (this.props.stats instanceof String && this.props.stats.indexOf('%') !== -1) {
        var style = {
          fontSize: '20px'
        };
